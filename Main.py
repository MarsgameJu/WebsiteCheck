...
def main():
    ...
    # Eingabeaufforderung für den Gobuster-Scan
    use_gobuster = input("\n🔍 Möchten Sie den Gobuster-Scan durchführen? [y/n]: ").strip().lower()

    # Sicherstellen, dass der Benutzer entweder "y" oder "n" eingibt
    while use_gobuster not in ["y", "n"]:
        use_gobuster = input("Bitte geben Sie 'y' für Ja oder 'n' für Nein ein: ").strip().lower()
